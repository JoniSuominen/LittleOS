 ...
 * the filesystem */
unsigned int read_fs(struct fs_node* node, unsigned int offset, unsigned int size, char * buffer);
unsigned int write_fs(struct fs_node* node, unsigned int offset, unsigned int size, char* buffer);
